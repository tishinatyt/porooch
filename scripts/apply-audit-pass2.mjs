...
// Private invitation acceptance is not implemented yet. Prevent creation of new unreachable private events while preserving existing private records so organizers can make them public.
replaceOnce(
  'src/pages/CreateEvent.tsx',
